...
#+EXPORT_FILE_NAME:	install-gui-in-wsl2-using-vcxsrv
...
#+HUGO_SECTION: /posts/linux/install-gui-in-wsl2-using-vcxsrv/

#+hugo_menu: :menu sidebar :name Install GUI in WSL2 using VcXsrv :identifier install-gui-in-wsl2-using-vcxsrv :parent linux :weight auto
#+HUGO_CATEGORIES: linux
#+HUGO_TAGS: wsl vcxsrv gui 
#+HUGO_DRAFT: false
#+hugo_custom_front_matter: :hero /posts/linux/install-gui-in-wsl2-using-vcxsrv/images/hero.svg
